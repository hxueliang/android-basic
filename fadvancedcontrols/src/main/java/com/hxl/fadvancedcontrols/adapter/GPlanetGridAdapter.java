...
public class GPlanetGridAdapter extends BaseAdapter {
    private final Context mContext;
    private final List<DPlanet> mPlaneList;

    // 右键 -> Generate -> Constructor
    public GPlanetGridAdapter(Context mContext, List<DPlanet> mPlaneList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.g_item_grid, null);
